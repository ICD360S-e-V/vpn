...
func renderClientConfig(in clientConfigInput) string {
	...
	// WireGuard App (NetworkExtension) handles 0.0.0.0/0 correctly
	// unlike wg-quick. No split routes needed. Server has no IPv6.
	fmt.Fprintln(&b, "AllowedIPs          = 0.0.0.0/0")
